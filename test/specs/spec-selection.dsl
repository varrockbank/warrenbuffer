...
const $sel = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
...
const $sel0 = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
...
const $sel1 = fixture.node.querySelectorAll(".buffee-zsel > pre")[1];
...
const $sel4 = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
expect($sel4.style.width).toBe("4ch");
// Select one more (col 5, still on row 0)
right with shift
EXPECT selection at 0,0-0,5
const $sel5 = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
...
const $r0a = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
expect($r0a.style.width).toBe("1ch");
const $r1a = fixture.node.querySelectorAll(".buffee-zsel > pre")[1];
expect($r1a.style.width).toBe("0ch");
// Select right again: row 1 col 1 (phantom position of "b")
right with shift
EXPECT selection at 0,1-1,1
const $r0b = fixture.node.querySelectorAll(".buffee-zsel > pre")[0];
expect($r0b.style.width).toBe("1ch");
const $r1b = fixture.node.querySelectorAll(".buffee-zsel > pre")[1];
...
const $sel2 = fixture.node.querySelectorAll(".buffee-zsel > pre")[2];
...
const $vp9 = fixture.node.querySelectorAll(".buffee-zsel > pre")[9];
