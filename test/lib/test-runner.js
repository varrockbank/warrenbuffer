...
function createEditorNode() {
  ...
  node.innerHTML = `
    ...
    <div class="no-select buffee-elements">
      ...
      <div class="buffee-lines" tabindex="0"><div class="buffee-zsel"></div><blockquote class="buffee-ztxt"></blockquote><div class="buffee-layer-elements"></div><div class="buffee-cursor"></div></div>
    </div>
